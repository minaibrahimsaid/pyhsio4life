            ...
            <div>
                ...
                <div class="carousel-inner" role="listbox">
                    <div id="offer-slide"
                        ...
                        <div class="mbr-table-cell">
                            <div id="per15"><img src="assets/images/15.png" width="15%">
                                <div style="">
                                    <h1 class="mbr-section-title display-1 text-aligin:left text-offer-1 shadow-text"
                                        style="      
                    ...
                    <div id="offer-slide2"
                        ...
                        data-bg-video-slide="false"
                        style="background-image:  url(assets/images/2.jpg);     margin-top: 90px;">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 lead">
                <blockquote class="quote"> &nbsp;we love them like you do&nbsp;&nbsp;&nbsp;<img
