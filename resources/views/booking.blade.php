                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group preferredAppointmentDate-group"><label
                                                    ...
                                                    <div class="DayPickerInput"><input type="date"
                                                            id="date-picker-input-1" class="form-control" name="date" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group firstName-group"><label for="firstName">
                                                        ...
                                                        class="form-control firstName" required placeholder="Owner Name"
                                                        name="ownername"></div>
                                            </div>
                                            <div class="col-sm-6">
                                            ...
                                            <div class="col-sm-12">
                                                <div class="form-group submit-button-group">
                                                    <button class="btn btn-primary g-recaptcha"
                                                        data-sitekey={{env('SECRET_CLIENT_KEY')}}
                                                        data-callback='onSubmit'>Book Now</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    function onSubmit(token) {
        document.getElementById("show-modal-book").submit();
        $("#modal-message").text(
            "Thank you for choosing us you , we will contact you soon"
        );
        $("#myModal").modal("show");
        $('#show-modal-book').prop( "disabled", true );
      }
</script>
@endsection